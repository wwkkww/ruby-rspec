...
RSpec.describe Movie do
  # mimic the exact interface of the class
  let(:stuntman) {double('Mr. Danger', { ready?: true, act: 'Start acting!', fall_off_ladder: 'lets do this', light_on_fire: true })}
  subject { described_class.new(stuntman) }

  describe '#start_shooting method' do
    it 'expect an actor to perform 3 actions' do
